const itinerary = [
  ...
  },
  {
    ...
    schedule: [
      ...
      ["16:30", "离开景区", "回酒店休息和整理行李。晚餐后给车辆加满油，确认次日返成都路况。"]
    ],
    notes: [
  ...
  },
  {
    ...
    weekday: "周二",
    title: "四姑娘山 → 成都",
    subtitle: "今天唯一 KPI 是回到成都。不要加都江堰、熊猫谷或任何返程景点。",
    distance: "约 220 km",
    drive: "5–9h",
    sleep: "成都",
    mapDay: 0,
    navigation: "https://uri.amap.com/navigation?from=102.838,31.002&to=104.066,30.573&mode=car&policy=1",
    schedule: [
      ["06:00", "退房出发", "早餐打包，避开景区退房高峰。出发前确认 G350、巴朗山/映秀方向与理小路分流信息。"],
      ["08:30", "安全停车区轮换司机", "山路保持低速，不跟车过近，不为超车长时间占用对向车道。"],
      ["11:30", "映秀或都江堰简餐", "依据堵车位置灵活调整；若车辆缓慢移动，在正规服务区解决。"],
      ["15:00", "进入成都 / 还车", "预留洗车、加油和验车时间。所有人一起核对遗留物、违章押金与电子合同。"],
      ["18:30", "成都收官晚餐", "住机场方向或地铁沿线。次日早班机住机场附近，下午航班可住市区。"]
    ],
    notes: [
      ["返程", "预计时间按 9 小时准备", "导航显示 5 小时也不要乐观安排晚间演出或不可退餐厅。"],
      ["还车", "同机场更简单", "若 10.7 下午航班，也建议今天还车，避免次日事故、加油和门店排队影响值机。"],
      ["机动", "到得早再逛成都", "先完成还车和入住，再决定是否去玉林路或建设路吃饭。"]
    ]
  },
  {
    label: "返程",
    ...
    weekday: "周三",
    title: "成都 → 广州",
    subtitle: "航班日保持简单：睡够、吃饭、提前到机场。山区行程已经在昨天结束。",
    distance: "市区转场",
    drive: "0.5–1.5h",
    sleep: "回家",
    mapDay: 0,
    navigation: "https://uri.amap.com/search?keyword=%E6%88%90%E9%83%BD%E6%9C%BA%E5%9C%BA",
    schedule: [
      ["08:30", "自然醒与早餐", "若是下午航班，可在酒店附近吃早餐；不跨城安排三星堆、都江堰等半日项目。"],
      ["航班前 3h", "前往机场", "国庆返程日交通和安检压力大，天府机场距离市区更远，按 3 小时以上预留。"],
      ["航班前 2h", "完成值机与托运", "五人统一检查身份证、充电宝随身携带、氧气瓶不得带上飞机。"],
      ["抵达后", "费用结算", "保存租车验车单和加油票，待违章查询窗口结束后再退团队机动金。"]
    ],
    notes: [
      ["航班", "建议 14:00 后起飞", "早班机需要牺牲休息，而且没有必要；下午至傍晚时段更从容。"],
      ["行李", "高原氧气不能乘机", "未使用的氧气瓶按机场与当地规定处置，不放进托运行李。"],
      ["结算", "保留 ¥1,000 暂缓分摊", "用于可能产生的违章、租车补差或遗漏费用，确认无误后再退。"]
    ]
  }
];
...
const planOptions = [
  {
    ...
    tab: "A · 日期优先 7 晚",
    badge: "推荐执行",
    title: "保留 10 月 6 日成都缓冲夜",
    summary: "完全按 9 月 30 日晚到达、10 月 7 日返程执行。多付一晚成都住宿，换来山区堵车不影响航班。",
    stats: [["住宿", "7 晚"], ["山区自驾", "6 天"], ["总里程", "约 1,050 km"], ["航班风险", "低"]],
    timeline: [
      ["9.30", "成都", "落地取车"], ["10.1", "康定", "纯转场"], ["10.2", "新都桥", "S434 / 塔公"], ["10.3", "丹巴", "八美下撤"],
      ["10.4", "四姑娘山", "藏寨 / 小金"], ["10.5", "四姑娘山", "双桥沟"], ["10.6", "成都", "完整返程"], ["10.7", "广州", "从容返航"]
    ],
    verdict: "适合已经确定 10 月 7 日白天或晚上航班的人。成本略高，但这是国庆自驾最值得买的一晚保险。"
  },
  {
    id: "compact",
    tab: "B · 严格压成 6 晚",
    badge: "不建议",
    title: "删掉 10 月 6 日成都住宿",
    summary: "必须购买 10 月 7 日凌晨航班，10 月 6 日从四姑娘山返成都后直接去机场。堵车、还车、加油和航班被绑在同一天。",
    stats: [["住宿", "6 晚"], ["最长连续日", "约 18 小时"], ["省下", "约 ¥700–1,500"], ["航班风险", "高"]],
    timeline: [
      ["9.30", "成都", "落地取车"], ["10.1", "康定", "纯转场"], ["10.2", "新都桥", "S434 / 塔公"], ["10.3", "丹巴", "八美下撤"],
      ["10.4", "四姑娘山", "藏寨 / 小金"], ["10.5", "四姑娘山", "双桥沟"], ["10.6", "机场", "返程 + 还车"], ["10.7", "广州", "凌晨抵达"]
    ],
    verdict: "只有机票已经锁定在 10 月 7 日 01:00 以后，且全员接受误机风险时才考虑。不能用删双桥沟或夜驾来进一步压缩。"
  }
];
...
const roadSegments = [
  ...
  ["10.6", "四姑娘山 → 映秀", "约 145 km", "G350 / 巴朗山方向，长下坡", "卧龙、耿达、映秀服务点", "返程拥堵、刹车热衰减", "每 90 分钟停车检查一次，不跟随导航抄小路"],
  ["10.6", "映秀 → 成都", "约 75 km", "都汶高速 / 城市快速路", "都江堰服务区、成都油站", "高速回堵、还车排队", "先加满油还车，再安排成都晚餐"]
];
...
const stays = [
  ...
  { date: "10.6", city: "成都 / 机场方向", alt: "约 500m", target: "¥450–800 / 间", rooms: "2 间，按航班选区域", area: "早班住机场；下午航班住地铁沿线", must: "完成还车后再入住、可延迟到店", avoid: "跨机场住宿、早班还住市中心", link: "https://uri.amap.com/search?keyword=%E6%88%90%E9%83%BD%E6%9C%BA%E5%9C%BA%E9%85%92%E5%BA%97" }
];
...
const spots = [
  ...
  { name: "四姑娘山双桥沟", region: "四姑娘山", level: "core", tag: "核心", time: "7–8h", cost: "¥150 / 人", altitude: "3,200–3,800m", rule: "提前 14 天实名预约", note: "全程唯一安排完整一天的收费景区。" },
  ...
  { name: "四姑娘山长坪沟", region: "四姑娘山", level: "backup", tag: "备选", time: "6–8h", cost: "票价现场核验", altitude: "3,200m+", rule: "替换双桥沟，不同日叠加", note: "徒步比重更大，适合队伍体力明确时。" },
  { name: "都江堰", region: "返程", level: "backup", tag: "备选", time: "3–4h", cost: "约 ¥80", altitude: "约 700m", rule: "只能放 10.7 且下午航班", note: "不能塞进 10.6 山区返程日。" },
...
const spotDetails = {
  ...
  "四姑娘山长坪沟": { image: "assets/spots/17-changping.jpg", imageLabel: "四姑娘山景区实景", credit: "File:四姑娘山景区 Mount Siguniang Scenic Area 17.jpg", xhs: "长坪沟 国庆 徒步 木骡子 马匹", photo: "枯树滩、森林与雪峰是主画面，但需要较多步行，不能照搬双桥沟节奏。", access: "只能替换双桥沟，不同日叠加；队伍体力、天气与景区交通都明确后再选。" },
  "都江堰": { image: "assets/spots/18-dujiangyan.jpg", imageLabel: "都江堰实景", credit: "File:Dujiangyan, Sichuan (20240906) P1.jpg", xhs: "都江堰 半日游 停车 国庆", photo: "鱼嘴、飞沙堰和南桥任选两处，不追求景区全走完。", access: "只能放在 10.7 下午航班的上午，至少预留 3–4 小时和前往机场时间。" },
...
function setupActions() {
  ...
  document.querySelector("[data-copy-plan]").addEventListener("click", async () => {
    const summary = "2026雪山优先川西小环线：9/30广州飞成都；10/1康定；10/2走S434看贡嘎、塔公看雅拉，住新都桥；10/3清晨新都桥/瓦泽再等贡嘎，经八美下撤丹巴，墨石仅阴天备选；10/4短游藏寨后16:30前到猫鼻梁看四姑娘山；10/5双桥沟按红杉林-布达拉峰-四姑娜措顺序看雪峰、公路和倒影；10/6回成都；10/7飞广州。5人、2位司机、约1050km，不走非铺装观景支线，不为日落夜驾。";
