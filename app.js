...
const stayRecommendations = [
  { city: "成都天府机场 / 简阳", date: "9.30", image: "assets/stays/chengdu.webp", imageAlt: "天府机场与简阳住宿环境参考图", type: "机场商务酒店", hotelOptions: ["天府机场周边含接送商务酒店类", "简阳城区停车酒店类", "天府机场航站楼附近酒店类"], area: "天府机场、简阳城区、成资大道方向", room: "2 间双床 / 家庭房", reason: "只负责落地、取车和睡一晚，优先 24 小时前台、免费停车、早餐可打包和第二天出城效率。", avoid: "春熙路核心区无停车酒店", search: "成都天府机场 简阳 酒店 免费停车 早餐", guide: "天府机场 酒店 停车 接送 国庆" },
...
const spotDetails = {
  ...
  "都江堰": { image: "assets/spots/18-dujiangyan.jpg", imageLabel: "都江堰实景", credit: "File:Dujiangyan, Sichuan (20240906) P1.jpg", xhs: "都江堰 国庆 半日游 离堆公园 停车", photo: "宝瓶口、飞沙堰和安澜索桥按人流选择两处，不追求全景区走完。", access: "A 线返程日不安排景区；B 线仅作为 10.6 下撤住宿，开放与停车以当天为准。" },
  "鱼子西空中花园": { image: "assets/spots/19-yuzixi.jpg", imageLabel: "贡嘎雪山参考", credit: "File:Minya Konka, from the west..jpg", xhs: "鱼子西 国庆 堵车 路况 日落", photo: "优势是贡嘎日落，但机位价值建立在晴天、道路和返程余量同时满足。", access: "条件支线：官方确认开放、道路干燥、全员无明显高反且能天黑前回到新都桥主路时才考虑。" },
